...
INSTALL() {
  ...
  curl -L ${GH_PROXY}https://github.com/xhofe/alist/releases/latest/download/alist-linux-amd64.tar.gz -o /tmp/alist-linux-amd64.tar.gz $CURL_BAR
  tar zxf /tmp/alist-linux-amd64.tar.gz -C $INSTALL_PATH/
